...
Original file is located at
    https://colab.research.google.com/drive/1Pml14KGIoSJVIzUBwbLchWtX4iCNxOlk
...
# first_model.add(Dense(10, )) -- compare this to see the importance of your output layer activation function
...
Walkthrough that this lab is built on: https://www.tensorflow.org/alpha/tutorials/images/intro_to_cnns

Walkthrough focusing on hyperparameters: https://www.pyimagesearch.com/2018/12/31/keras-conv2d-and-convolutional-layers/
"""
...
Good answer on setting number of filters: https://stackoverflow.com/questions/48243360/how-to-determine-the-filter-parameter-in-the-keras-conv2d-function

Convolutional documentation: https://keras.io/layers/convolutional/; https://www.tensorflow.org/api_docs/python/tf/keras/layers/Conv2D

Padding:
- same: input dimensions = output dimensions; each pixel equally weighted
- valid: input dimensions > output dimensions; only do convolution over actual image
"""
...
cnn_model_history = cnn_model.fit(x = X_train,
                                y = y_train,
                                batch_size = 64,
                                epochs = 5,
                                validation_split = 0.2,
...
plt.figure(figsize=(6,3))
plt.subplot(1,2,1)
plot_image(i, predictions, y_test, X_test_plot)
plt.subplot(1,2,2)
plot_value_array(i, predictions,  y_test)
plt.show()
